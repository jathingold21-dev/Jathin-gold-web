...
export const customerReviews: CustomerReview[] = [
  {
    ...
    quote:
      'I visited the Kothagudem desk to sell old family jewellery. They tested each piece using their German XRF Karatmeter right in front of me with zero melting or acid. Complete transparency and paid to my account in 10 minutes.',
    author: 'Priya Raman',
    role: 'Kothagudem, Telangana',
  ...
  },
  {
    ...
    quote:
      'Compared quotes across three different gold buyers in Telangana. Jathin Gold offered the highest rate per gram based on live MCX prices without any hidden fee deductions. Genuine, courteous, and very professional team.',
    author: 'Ramesh Naidu',
    role: 'Andhra Pradesh',
